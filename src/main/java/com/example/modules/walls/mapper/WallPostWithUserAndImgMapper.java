 ...
 */
@Mapper
public interface WallPostWithUserAndImgMapper {
    @Select("select wall_post.id,user.id AS userid,user.headaddress,user.nickname,wall_post.title,wall_post.content,wall_post.head_img,wall_post.like_count,wall_post.comments_count,wall_post.version,\n" +
