...
//    void sda(){
////        String key = "longtt";
//////        redisTemplate.opsForHash().put(key,"f1","ltttt");
////        System.out.println(redisTemplate.opsForHash().get(key, "f1"));
////        System.out.println(redisTemplate.opsForHash().get(key, "f2"));
////        String key="longttttt";
////        redisTemplate.opsForList().leftPush(key,"adsdadasda")
